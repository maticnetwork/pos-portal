...
export interface ChildMintableERC721Interface extends utils.Interface {
  functions: {
...
export interface TransferWithMetadataEventObject {
  from: string;
  to: string;
  tokenId: BigNumber;
  metaData: string;
}
export type TransferWithMetadataEvent = TypedEvent<
  [string, string, BigNumber, string],
  TransferWithMetadataEventObject
>;

export type TransferWithMetadataEventFilter =
  TypedEventFilter<TransferWithMetadataEvent>;
...
export interface ChildMintableERC721 extends BaseContract {
  ...
  filters: {
    ...
    "TransferWithMetadata(address,address,uint256,bytes)"(
      ...
      tokenId?: PromiseOrValue<BigNumberish> | null,
      metaData?: null
    ): TransferWithMetadataEventFilter;
