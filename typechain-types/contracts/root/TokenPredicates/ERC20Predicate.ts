...
export interface ERC20PredicateInterface extends utils.Interface {
  functions: {
...
export interface ExitedERC20EventObject {
  exitor: string;
  rootToken: string;
  amount: BigNumber;
}
...
export interface ERC20Predicate extends BaseContract {
