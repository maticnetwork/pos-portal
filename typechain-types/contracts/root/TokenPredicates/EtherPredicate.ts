...
export interface EtherPredicateInterface extends utils.Interface {
  functions: {
...
export interface ExitedEtherEventObject {
  exitor: string;
  amount: BigNumber;
}
export type ExitedEtherEvent = TypedEvent<
  [string, BigNumber],
  ExitedEtherEventObject
>;
...
export interface EtherPredicate extends BaseContract {
