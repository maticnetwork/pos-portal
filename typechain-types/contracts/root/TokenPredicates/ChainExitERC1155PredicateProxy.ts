...
export interface ChainExitERC1155PredicateProxyInterface
...
export interface ChainExitERC1155PredicateProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChainExitERC1155PredicateProxyInterface;
