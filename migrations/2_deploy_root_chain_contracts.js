...
module.exports = async(deployer) => {
  ...
  await rootChainManagerProxy.updateAndCall(rootChainManager.address, rootChainManager.contract.methods.initialize().encodeABI())
  ...
  await erc20PredicateProxy.updateAndCall(erc20Predicate.address, erc20Predicate.contract.methods.initialize().encodeABI())
  ...
  await erc721PredicateProxy.updateAndCall(erc721Predicate.address, erc20Predicate.contract.methods.initialize().encodeABI())
  ...
  await erc1155PredicateProxy.updateAndCall(erc1155Predicate.address, erc1155Predicate.contract.methods.initialize().encodeABI())
  ...
  await etherPredicateProxy.updateAndCall(etherPredicate.address, etherPredicate.contract.methods.initialize().encodeABI())
