...
contract WETH is ERC20, AccessControl {
    ...
    bytes32 public constant ROOT_CHAIN_MANAGER_ROLE = keccak256(
        "ROOT_CHAIN_MANAGER_ROLE"
    );
    ...
    function withdrawFor(uint256 amount, address user)
        external
        only(ROOT_CHAIN_MANAGER_ROLE)
    {
