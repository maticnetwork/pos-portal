...
contract('MintableERC1155Predicate', (accounts) => {
  describe('lockTokens', () => {
    ...
    it('Should be able to receive lockTokens tx', async () => {
      ...
      await expect(
        mintableERC1155Predicate.lockTokens(
          depositor.address,
          depositReceiver,
    ...
    it('Should revert with correct reason', async () => {
      ...
      await expect(
        mintableERC1155Predicate
          .connect(depositor)
          .lockTokens(depositor.address, depositReceiver, dummyMintableERC1155.target, depositData)
  ...
  describe('exitTokens single', () => {
    ...
    before(async () => {
      ...
      const depositData = constructERC1155DepositData([tokenId], [amount])
      await mintableERC1155Predicate.lockTokens(
        depositor.address,
  ...
  describe('exitTokens batch', () => {
    ...
    it('Should be able to receive exitTokens tx', async () => {
      ...
      await expect(
        ...
        .withArgs(withdrawer, dummyMintableERC1155.target, [tokenIdA, tokenIdB], [burnAmountA, burnAmountB])
    })
  ...
  describe('exitTokens called by different user', () => {
    ...
    it('Should be able to receive exitTokens tx', async () => {
      ...
      await expect(
        ...
        .to.emit(mintableERC1155Predicate, 'ExitedBatchMintableERC1155')
        .withArgs(withdrawer, dummyMintableERC1155.target, [tokenIdA, tokenIdB], [amountA, amountB])
    })
  ...
  describe('exitTokens called by non manager', () => {
    ...
    it('Should revert with correct reason', async () => {
      ...
      await expect(
        mintableERC1155Predicate
          .connect(nonManager)
          .exitTokens(dummyMintableERC1155.target, dummyMintableERC1155.target, burnLog)
      ).to.be.revertedWith('MintableERC1155Predicate: INSUFFICIENT_PERMISSIONS')
    })
  })
})
