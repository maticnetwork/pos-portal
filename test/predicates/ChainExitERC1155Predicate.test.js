...
contract('ChainExitERC1155Predicate', (accounts) => {
  describe('lockTokens', () => {
    ...
    it('Should be able to receive lockTokens tx', async () => {
      await expect(chainExitERC1155Predicate.lockTokens(depositor, depositReceiver, dummyMintableERC1155.target, depositData)).to.emit(
  ...
  describe('lockTokens called by non manager', () => {
    ...
    it('Should revert with correct reason', async () => {
      await expect(chainExitERC1155Predicate.connect(depositor)
  ...
  describe('exitTokens', () => {
    ...
    before(async () => {
      ...
      await chainExitERC1155Predicate.lockTokens(depositor, mockValues.addresses[2], dummyMintableERC1155.target, depositData);
    ...
    it('Should be able to receive exitTokens tx', async () => {
      ...
      exitTokensTx = await chainExitERC1155Predicate.exitTokens(dummyMintableERC1155.target, dummyMintableERC1155.target, burnLog);
  ...
  describe('exitTokens with real burn log', () => {
    ...
    it('Should revert with correct reason', async () => {
      ...
      await expect(chainExitERC1155Predicate.exitTokens(dummyMintableERC1155.target, dummyMintableERC1155.target, burnLog))
