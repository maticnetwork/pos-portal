...
// File: contracts/child/ChildToken/BaseERC20.sol
...
contract BaseERC20 {
    ...
    /**
     * @dev Destroys `amount` tokens, from `account`. This method is supposed to be
     * invoked when user is interested in burning token(s) on both L2, L1. 
     */
...
// File: contracts/child/ChildToken/ChildBurnableERC20.sol
