...
// File: contracts/child/ChildToken/UpgradeableChildERC721/ERC721.sol
...
// File: contracts/child/ChildToken/UpgradeableChildMintableERC721/UChildMintableERC721.sol
...
contract UChildMintableERC721 is
    ERC721,
    IChildToken,
    AccessControlMixin,
    ...
    ContextMixin
{
        ...
        initializer
    {
        setName(name_);
        setSymbol(symbol_);
        _setupContractId(string(abi.encodePacked("ChildMintable", symbol_)));
